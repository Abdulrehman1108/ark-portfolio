...
export default function About() {
  ...
  return (
    <section ref={ref} className="pt-24 md:pt-[150px]" id="about">
      ...
      >
        I give brands a powerful voice through the web.
      </AnimatedTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[8.5fr_3.5fr] gap-8 mt-6">
        <div className="grid grid-cols-1 antialiased gap-6 text-white/80 text-xl md:text-2xl">
          ...
          <AnimatedBody className="leading-[34px] md:leading-[39px]">
            From writing my first lines of code back in late 2021 to this point
        ...
        <div className="grid grid-cols-1 gap-4">
          <div>
            ...
            <AnimatedBody className="text-white/60 text-base md:text-xl leading-8">
              JavaScript(ES2024), React, Next.js, TypeScript, Redux, Redux
          ...
          <div>
            ...
            <AnimatedBody className="text-white/60 text-base md:text-xl leading-8">
              Figma, FigJam,Canva, UX Research, UI Design, Prototyping.
            </AnimatedBody>
          </div>
        </div>
      </div>
